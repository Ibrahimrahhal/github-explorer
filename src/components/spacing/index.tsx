type SpacingInput = number | [number, number] | [number, number, number, number];
type SpacingProps = {
...
export const SpacingHOC =  <InputProps extends React.HTMLAttributes<HTMLElement>, >(Component: React.ComponentType<InputProps>) => {
